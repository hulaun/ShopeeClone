      ...
      <motion.div className='flex flex-col bg-white justify-between h-full'
        ...
        <motion.div className='pt-6 flex flex-col items-center'>
          ...
          <motion.div className='flex flex-col pt-12 h-full w-full'>
            <motion.div 
              className="flex justify-center items-center gap-3 h-full w-full p-3"
              variants={bgVariants}
              initial="passive"
              animate="passive"
              whileHover="active"
            ...
            <motion.div 
              ...
              <motion.svg
                ...
                <motion.path
                  variants={svgVariants}
                  fill-rule="evenodd" clip-rule="evenodd" d="M18.7071 9.8065C18.7071 11.0726 19.039 11.8189 19.7695 12.6789C20.3231 13.3124 20.5 14.1257 20.5 15.008C20.5 15.8893 20.2128 16.7259 19.6373 17.4052C18.884 18.2195 17.8215 18.7393 16.7372 18.8297C15.1659 18.9647 13.5937 19.0784 12.0005 19.0784C10.4063 19.0784 8.83505 19.0104 7.26375 18.8297C6.17846 18.7393 5.11602 18.2195 4.36367 17.4052C3.78822 16.7259 3.5 15.8893 3.5 15.008C3.5 14.1257 3.6779 13.3124 4.23049 12.6789C4.98384 11.8189 5.29392 11.0726 5.29392 9.8065V9.37701C5.29392 7.68142 5.71333 6.57268 6.577 5.4873C7.86106 3.90441 9.91935 2.95508 11.9558 2.95508H12.0452C14.1254 2.95508 16.2502 3.9501 17.5125 5.60102C18.3314 6.66406 18.7071 7.72609 18.7071 9.37701V9.8065ZM9.07324 21.1618C9.07324 20.6542 9.53539 20.4216 9.96275 20.3221C10.4627 20.2155 13.5088 20.2155 14.0088 20.3221C14.4361 20.4216 14.8983 20.6542 14.8983 21.1618C14.8734 21.6451 14.5922 22.0736 14.2036 22.3457C13.6997 22.7417 13.1083 22.9925 12.4901 23.0828C12.1482 23.1275 11.8123 23.1285 11.4824 23.0828C10.8632 22.9925 10.2718 22.7417 9.76895 22.3447C9.37935 22.0736 9.09809 21.6451 9.07324 21.1618Z"/>
              </motion.svg>
              <motion.div
              variants={navItemVariants}>
                Notification
        ...
        <motion.div className='flex flex-col items-center py-6 gap-4'>
          ...
          <motion.div className="flex justify-center items-center  h-full w-full py-3"
              variants={bgVariants}
              initial="passive"
              animate="passive"
              whileHover="active"
